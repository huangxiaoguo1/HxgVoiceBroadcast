...
public class VoicePlaySingle {
    ...
    private VoicePlaySingle(Context context) {
        this.mContext = context;
        this.mExecutorService = Executors.newSingleThreadExecutor();
    }

    private volatile static VoicePlaySingle mVoicePlay = null;
     ...
     * @return
     */
    public static VoicePlaySingle with(Context context) {
        if (mVoicePlay == null) {
            synchronized (VoicePlaySingle.class) {
                if (mVoicePlay == null) {
                    mVoicePlay = new VoicePlaySingle(context);
                }
            }
        }
        return mVoicePlay;
    ...
    private void start(final List<String> voicePlay) {
        synchronized (VoicePlaySingle.this) {
